...
test('Search should render correct amount fo shows based on search term - without Redux', () => {
...
test(
  "Search should render correct amount fo shows based on search term - with Redux",
  () => {
    const searchWord = "black";
